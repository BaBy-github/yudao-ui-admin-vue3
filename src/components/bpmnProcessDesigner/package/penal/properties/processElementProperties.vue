  ...
  <div class="panel-tab__content">
    ...
    >
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="saveFormAttribute">确 定</el-button>
      </template>
    </el-dialog>
  </div>
</template>
...
const getElementPropertyList = () => {
  console.log(
    '<<< getElementPropertyList',
    bpmnElementPropertyList.value,
    elementPropertyList.value
  )
  return elementPropertyList.value
}
